  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="space-y-2">
        <h2 className="text-3xl font-extrabold text-on-surface tracking-tight">Bem-vindo de volta</h2>
        <p className="text-text-secondary">Entre para organizar sua semana na cozinha.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-4">
          <div className="space-y-1.5">
            <label htmlFor="login-email" className="text-xs font-bold uppercase tracking-widest text-on-surface-variant ml-1">E-mail</label>
          ...
          <div className="space-y-1.5">
            <div className="flex justify-between items-center px-1">
              <label htmlFor="login-password" className="text-xs font-bold uppercase tracking-widest text-on-surface-variant">Senha</label>
              <Link to="/auth/recuperar" className="text-xs font-bold text-primary hover:underline">Esqueceu?</Link>
            </div>
            <div className="relative group">
              ...
              <button 
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 text-warm-gray-medium hover:text-on-surface transition-colors"
              >
        ...
        <div className="space-y-4 pt-2">
          ...
          >
            {isLoading ? <Loader2 className="h-5 w-5 animate-spin" /> : 'Entrar na conta'}
          ...
          <div className="relative py-2">
            ...
            <div className="relative flex justify-center">
              <span className="bg-surface px-4 text-xs font-bold text-warm-gray-medium uppercase tracking-tighter">Ou continue com</span>
            </div>
          </div>
          ...
          <button 
            ...
            className="w-full py-4 bg-white border border-neutral-200 rounded-2xl font-bold text-on-surface hover:bg-neutral-50 active:scale-[0.98] transition-all flex justify-center items-center gap-3 shadow-sm"
          >
      ...
      <p className="text-center font-medium text-text-secondary pt-4">
        Ainda não tem uma conta? <Link to="/auth/cadastro" className="text-primary font-bold hover:underline">Criar conta gratuita</Link>
      </p>
    </div>
  )
}
