...
export function RichTextEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class: cn(
          'px-3 py-2.5 text-sm text-slate-800 outline-none focus:outline-none relative leading-relaxed [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_strong]:font-semibold [&_em]:italic [&_u]:underline',
          `min-h-[${minHeight}]`
        ),
